                                ...
                                <tbody>
                                  <tr>
                                    <td style="padding: 10px;" valign="top" align="center">
                                      <a href="http://example.com" style="text-decoration: none;"><https://prep.soyhenry.com/logo.png?fbclid=IwAR2O4craMkp3dbR3sKvES9eS9LDzQnSVKr_wvtA-3CzDbd4aqIXGdUQz-XU" alt="" style="height: auto; max-width: 30%; border: 0; line-height: 30%; outline: 0; -ms-interpolation-mode: bicubic; color: #ffffff; font-size: 14px;" width="130" height=""></a>
                                    </td>
                                  </tr>
                                  <tr>
                          ...
                          <tr>
                            <td class="pc-sm-p-35-30-40 pc-xs-p-20-20-25" style="padding: 35px 40px 40px; background-color: #ffffff; border-radius: 8px" valign="top" bgcolor="#ffffff">
                              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                  <tr>
                                    <td style="padding: 5px 0; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 24px; font-weight: 700; line-height: 34px; letter-spacing: -0.4px; color: #151515;" valign="top" align="center">Bienvenido a HenryApp!!</td>
                                  </tr>
                                  <tr>
                                ...
                                <tbody>
                                  <tr>
                                    <td valign="top" align="center">
                                      <img src="https://images.unsplash.com/photo-1487505983481-9aa2d9f9901a?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max&ixid=eyJhcHBfaWQiOjF9" alt="" style="border: 0; line-height: 100%; outline: 0; -ms-interpolation-mode: bicubic; display: block; color: #151515; max-width: 100%; height: auto; Margin: 0 auto;" width="384" height="">
                                    </td>
                                  </tr>
                                  <tr>
                                ...
                                <tbody>
                                  <tr>
                                    <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 24px; font-weight: 700; line-height: 34px; letter-spacing: -0.4px; color: #151515;" valign="top" align="center">Una oportunidad que cambia tu vida</td>
                                  </tr>
                                  <tr>
                                ...
                                <tbody>
                                  <tr>
                                    <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 300; line-height: 28px; letter-spacing: -0.2px; color: #9B9B9B;" valign="top" align="center">Estamos emocionados de tenerte como estudiante, clickea en el botón y completa tus datos.</td>
                                  </tr>
                                  <tr>
                                    <td style="font-size: 1px; line-height: 1px;" height="20">&nbsp;</td>
                                  </tr>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td style="border-radius: 8px; padding: 13px 17px; background-color: #ffff01" valign="top" bgcolor="#ffff01" align="center">
                                              <a href="http://localhost:3000/root/register" style="line-height: 24px; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #080707">Ingresar</a>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
...
/* MAIL PARA REESTABLECER CONTRASEÑA
